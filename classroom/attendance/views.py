...
def identify_faces(video_capture):
    ...
    while True:
        ...
        if process_this_frame:
            predictions = predict(rgb_frame, model_path="attendance/facerec/models/trained_model.clf")
            # print(predictions)
...
def add_photos(request):
	...
	return render(request, 'attendance/add_photos.html', {'emp_list': emp_list})
...
def detected(request):
	...
	return render(request, 'attendance/detected.html', {'det_list': det_list, 'date': date_formatted})
...
def add_emp(request):
    if request.method == "POST":
        ...
        form = EmployeeForm()
    return render(request, 'attendance/add_emp.html', {'form': form})
